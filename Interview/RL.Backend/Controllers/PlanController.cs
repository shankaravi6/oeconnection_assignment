...
public class PlanController : ControllerBase
{
    ...
    [HttpPost("AddProcedureUsersToPlan")]
    public async Task<IActionResult> AddProcedureUsersToPlan([FromBody] List<AddProcedureUsersToPlanCommand> commands, CancellationToken token)
    {
